...
public class DepartmentConsumerRestMockTest {
    ...
    public void init(){
        ...
        department = new Department("name3","kek");
    ...
    public void getAllDepartmentDTOs() {
        ...
        Collection<DepartmentDTO> results = departmentService.getDepartmentsDTO();
    ...
    public void getDepartmentById(){
        ...
        Assert.assertEquals("name3", result.getDepartmentName());
    }
